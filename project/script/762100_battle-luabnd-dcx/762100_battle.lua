...
function AngelsDaughters762100_Act49(ai, goal, paramTbl)
    ...
    elseif ai:HasSpecialEffectId(TARGET_ENE_2, 60730) == true then
        -- NR6PF: Why do I have to fix Fromsoft's errors too? Correctly target TARGET_ENE_2
        goal:AddSubGoal(GOAL_COMMON_ApproachSettingDirection, ai:GetRandam_Int(1, 2), TARGET_ENE_2, 10, TARGET_SELF, true, -1, AI_DIR_TYPE_ToL, ai:GetRandam_Int(4, 5))
