...
$Event(0, Default, function() {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015002, 0, 48700200, 0, 48705210, 1010, 356000, -1, 903560000, 48700800);
        $InitializeCommonEvent(0, 90015470, 48702200, 48700200, 48700800, 48705210, 0, 0);
