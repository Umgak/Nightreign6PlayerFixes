...
$Event(0, Default, function() {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015002, 0, 49260200, 0, 49260800, 1020, 950000, -1, 903050500, 49260800);
        $InitializeCommonEvent(0, 90015470, 49262200, 49260200, 49260800, 49260800, 49265801, 0);
    }
    if (IsMapVariation(2)) {
