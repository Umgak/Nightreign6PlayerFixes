...
$Event(0, Default, function() {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015002, 0, 49170200, 0, 49175210, 1020, 931000, -1, 904770000, 49170800);
        $InitializeCommonEvent(0, 90015470, 49172200, 49170200, 49170800, 49175210, 0, 0);
