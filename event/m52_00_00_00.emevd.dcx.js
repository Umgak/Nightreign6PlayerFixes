...
$Event(0, Default, function() {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015002, 0, 52000200, 0, 52000800, 1020, 941000, -1, 905040600, 52000800);
        $InitializeCommonEvent(0, 90015470, 52002200, 52000200, 52000800, 52000800, 52000810, 0);
