...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90035214, 45525810, 45520200, 45520201, 45520202, 45520203, 45520204, 45520205, 45520820); // NR6PF: Initialize new flags
    if (IsPlayerNo(1)) {
    ...
    // NR6PF: Maris invasion
    if (IsPlayerNo(4)) {
        InitializeCommonEvent(0, 90035215, 45520800, 45522800, 45522801, 45525810, 45520203, 45520820);
    }
    if (IsPlayerNo(5)) {
        InitializeCommonEvent(0, 90035215, 45520800, 45522800, 45522801, 45525810, 45520204, 45520820);
    }
    if (IsPlayerNo(6)) {
        InitializeCommonEvent(0, 90035215, 45520800, 45522800, 45522801, 45525810, 45520205, 45520820);
    }    
