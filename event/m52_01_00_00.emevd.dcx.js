...
$Event(0, Default, function() {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015002, 0, 52010200, 0, 52015210, 1020, 931000, -1, 905820600, 52010800);
        $InitializeCommonEvent(0, 90015470, 52012200, 52010200, 52010800, 52015210, 0, 0);
