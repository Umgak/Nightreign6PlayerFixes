...
$Event(0, Default, function() {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015002, 0, 48900200, 0, 48900800, 1020, 921200, -1, 904580600, 48900800);
        $InitializeCommonEvent(0, 90015470, 48902200, 48900200, 48900800, 48900800, 48905210, 0);
    }
    if (IsMapVariation(2)) {
