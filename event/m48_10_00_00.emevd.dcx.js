...
$Event(0, Default, function() {
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015002, 0, 48100200, 0, 48105210, 1020, 782000, -1, 907820000, 48100800);
        $InitializeCommonEvent(0, 90015470, 48102200, 48100200, 48100800, 48105210, 0, 0);
