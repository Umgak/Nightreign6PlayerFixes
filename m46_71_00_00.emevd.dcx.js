...
$Event(0, Default, function() {
    $InitializeCommonEvent(0, 90015000, 0, 46715800, 904480312, 30, 0, 0);
    $InitializeCommonEvent(0, 90015030, 0, 46715800, 30, 920910, 0);
    $InitializeCommonEvent(0, 90015002, 0, 0, 46710800, 46715800, 1020, 920910, 11290, 904480312, 46710500);
    ...
    Goto(S1);
S0:
    $InitializeCommonEvent(0, 90015008, 0, 46710800, 920910, 46715800, 0, 0);
S1:
    if (0 != 0) {
